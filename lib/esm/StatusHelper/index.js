...
var SBadge = styled(Typography)(function (_a) {
    var theme = _a.theme;
    return ({
...
export default (function (_a) {
    var icon = _a.icon, text = _a.text, badge = _a.badge, image = _a.image, _b = _a.mask, mask = _b === void 0 ? false : _b, _c = _a.reverse, reverse = _c === void 0 ? false : _c, _d = _a.reverseIcon, reverseIcon = _d === void 0 ? false : _d, children = _a.children, _e = _a.childrenIndex, childrenIndex = _e === void 0 ? 1 : _e, className = _a.className, style = _a.style;
    return _jsxs(SStack, __assign({}, { id: 'statusHelper', style: style, className: className, reverse: reverse.toString() }, { children: [icon && _jsx(SIcon, __assign({}, { id: 'sh.icon', reverse: reverseIcon.toString() }, { children: icon })), children && _jsx(_Fragment, { children: childrenIndex ? _jsx(SChildren, __assign({}, { index: childrenIndex }, { children: children })) : children }), image && _jsx(SImg, __assign({}, { id: 'sh.image', alt: '', mask: mask.toString(), src: image })), !!badge && _jsx(SBadge, __assign({}, { id: 'sh.badge' }, { children: String(badge) })), text && _jsx(SText, __assign({}, { id: 'sh.text', variant: 'caption' }, { children: text }))] }));
});
