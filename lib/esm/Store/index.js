...
var IndustrialProvider = function (_a) {
    ...
    return _jsx(DataContext.Provider, __assign({ value: {
            ...
            logDebug: logDebug,
        } }, { children: _jsx(Wrapper, __assign({}, { children: children, slim: slim, style: style })) }));
};
