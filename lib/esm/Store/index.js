...
function IndustrialProvider(_a) {
    var _b = _a.disabled, disabled = _b === void 0 ? false : _b, expand = _a.expand, hasLock = _a.hasLock, _c = _a.position, position = _c === void 0 ? PlacementPosition.TOP : _c, allowRightClick = _a.allowRightClick, _d = _a.hasBorder, hasBorder = _d === void 0 ? true : _d, _e = _a.fullWidth, fullWidth = _e === void 0 ? false : _e, _f = _a.justifyContent, justifyContent = _f === void 0 ? 'space-between' : _f, debug = _a.debug, children = _a.children, style = _a.style, _g = _a.size, size = _g === void 0 ? 'small' : _g, _h = _a.variant, variant = _h === void 0 ? 'default' : _h;
    ...
    return _jsx(DataContext.Provider, __assign({ value: {
            ...
            logDebug: logDebug,
        } }, { children: _jsx(Wrapper, __assign({}, { disabled: disabled, children: children, style: style })) }));
}
