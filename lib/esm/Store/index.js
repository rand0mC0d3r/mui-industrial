...
var IndustrialProvider = function (_a) {
    ...
    var log = function () {
        ...
        if (settings.debug) {
            // console.clear();
            // console.log.apply()
            console.log.apply(console, props);
        }
    };
    ...
    var handleKeyboardAnnouncement = function (_a) {
        ...
        setShortcuts(function (prevShortcuts) {
            var result = __spreadArray(__spreadArray([], prevShortcuts
    ...
    var handleKeyboardDestroy = function (id) {
        setShortcuts(function (prevShortcuts) {
    ...
    var handleKeyboardsDestroy = function (ids) {
        setShortcuts(function (prevShortcuts) {
    ...
    return _jsx(DataContext.Provider, __assign({ value: {
            ...
            handleKeyboardsDestroy: handleKeyboardsDestroy,
