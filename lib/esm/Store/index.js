...
var IndustrialProvider = function (_a) {
    ...
    var handleKeyboardAnnouncement = function (_a) {
        ...
        if (findShortcut && JSON.stringify(findShortcut) === JSON.stringify({ id: id, label: label, ascii: ascii, char: char, shiftKey: shiftKey, ctrlKey: ctrlKey, altKey: altKey, metaKey: metaKey, insensitive: insensitive }))
            return;
