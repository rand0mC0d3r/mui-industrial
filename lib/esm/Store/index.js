...
var IndustrialProvider = function (_a) {
    ...
    var _k = useState([]), commands = _k[0], setCommands = _k[1];
    var _l = useState([]), shortcuts = _l[0], setShortcuts = _l[1];
    var _m = useState(initialSettings), settings = _m[0], setSettings = _m[1];
    ...
    var handleCommandRegister = function (_a) {
        var id = _a.id, shortcutId = _a.shortcutId, label = _a.label, onClick = _a.onClick, disabled = _a.disabled, hidden = _a.hidden, icon = _a.icon, order = _a.order, tooltip = _a.tooltip;
        ...
        if (c && generateSignatureNg(c.id, c.shortcutId, c.label, c.tooltip) === generateSignatureNg(id, shortcutId, label, tooltip))
            return;
        var newCommand = { id: id, label: label, shortcutId: shortcutId, onClick: onClick, disabled: disabled, hidden: hidden, icon: icon, order: order, tooltip: tooltip };
