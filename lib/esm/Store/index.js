...
function IndustrialProvider(_a) {
    ...
    var handleKeyboardAnnouncement = function (_a) {
        var uniqueId = _a.uniqueId, id = _a.id, label = _a.label, ascii = _a.ascii, char = _a.char, shiftKey = _a.shiftKey, ctrlKey = _a.ctrlKey, altKey = _a.altKey, insensitive = _a.insensitive, onTrigger = _a.onTrigger;
