...
function StatusProvider(_a) {
    var expand = _a.expand, hasLock = _a.hasLock, _b = _a.position, position = _b === void 0 ? PlacementPosition.Top : _b, allowRightClick = _a.allowRightClick, _c = _a.hasBorder, hasBorder = _c === void 0 ? true : _c, _d = _a.fullWidth, fullWidth = _d === void 0 ? false : _d, _e = _a.justifyContent, justifyContent = _e === void 0 ? 'space-between' : _e, debug = _a.debug, children = _a.children, style = _a.style, _f = _a.size, size = _f === void 0 ? 'small' : _f, rest = __rest(_a, ["expand", "hasLock", "position", "allowRightClick", "hasBorder", "fullWidth", "justifyContent", "debug", "children", "style", "size"]);
    var _g = useState([]), status = _g[0], setStatus = _g[1];
    var _h = useState([]), snackbar = _h[0], setSnackbar = _h[1];
    var _j = useState(initialSettings), settings = _j[0], setSettings = _j[1];
    ...
    useEffect(function () {
        setSettings(function (settings) { return (__assign(__assign({}, settings), { expand: expand || initialSettings.expand, position: position, justifyContent: justifyContent, hasBorder: hasBorder, size: size, fullWidth: fullWidth, allowRightClick: allowRightClick || initialSettings.allowRightClick, debug: debug || initialSettings.debug, hasLock: valOrDefault(hasLock, initialSettings.hasLock) })); });
