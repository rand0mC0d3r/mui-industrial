...
var IndustrialProvider = function (_a) {
    ...
    var handleSnackbarRegister = function (_a) {
        var actions = _a.actions, _b = _a.autoHideDuration, autoHideDuration = _b === void 0 ? 5000 : _b, code = _a.code, message = _a.message, severity = _a.severity, source = _a.source;
        var id = Math.random().toString(36).substring(7);
        setSnackbars(function (snackbars) { return __spreadArray(__spreadArray([], snackbars, true), [
            {
                actions: actions,
