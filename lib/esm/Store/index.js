...
function StatusProvider(_a) {
    var expand = _a.expand, hasLock = _a.hasLock, _b = _a.position, position = _b === void 0 ? PlacementPosition.Top : _b, allowRightClick = _a.allowRightClick, _c = _a.hasBorder, hasBorder = _c === void 0 ? true : _c, _d = _a.justifyContent, justifyContent = _d === void 0 ? 'space-between' : _d, debug = _a.debug, children = _a.children, style = _a.style, rest = __rest(_a, ["expand", "hasLock", "position", "allowRightClick", "hasBorder", "justifyContent", "debug", "children", "style"]);
    var _e = useState([]), status = _e[0], setStatus = _e[1];
    var _f = useState([]), snackbar = _f[0], setSnackbar = _f[1];
    var _g = useState(initialSettings), settings = _g[0], setSettings = _g[1];
    ...
    useEffect(function () {
        ...
        setSettings(function (settings) { return (__assign(__assign({}, settings), { expand: expand || initialSettings.expand, position: position, justifyContent: justifyContent, hasBorder: hasBorder, allowRightClick: allowRightClick || initialSettings.allowRightClick, debug: debug || initialSettings.debug, hasLock: valOrDefault(hasLock, initialSettings.hasLock) })); });
