...
var IndustrialProvider = function (_a) {
    ...
    var handleKeyboardAnnouncement = function (_a) {
        var id = _a.id, label = _a.label, ascii = _a.ascii, char = _a.char, shiftKey = _a.shiftKey, ctrlKey = _a.ctrlKey, altKey = _a.altKey, metaKey = _a.metaKey, insensitive = _a.insensitive;
        var findShortcut = shortcuts.find(function (shortcut) { return shortcut.id === id; });
        if (!(!!findShortcut
            && JSON.stringify(findShortcut) !== JSON.stringify({ id: id, label: label, ascii: ascii, char: char, shiftKey: shiftKey, ctrlKey: ctrlKey, altKey: altKey, metaKey: metaKey, insensitive: insensitive }))) {
