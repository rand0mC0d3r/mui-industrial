...
function IndustrialProvider(_a) {
    ...
    var handleKeyboardAnnouncement = function (_a) {
        var uniqueId = _a.uniqueId, id = _a.id, label = _a.label, ascii = _a.ascii, char = _a.char, shiftKey = _a.shiftKey, ctrlKey = _a.ctrlKey, commandAltKey = _a.commandAltKey, insensitive = _a.insensitive, onTrigger = _a.onTrigger;
        setShortcuts(function (shortcuts) {
            var findError = status.find(function (shortcut) { return uniqueId === shortcut.uniqueId; });
            if (findError) {
                console.error("".concat(packageName, ": \u274C Same shortcut already registered with id: [").concat(id, "] & uniqueId: [").concat(uniqueId, "]"));
            }
            return __spreadArray(__spreadArray([], shortcuts.filter(function (shortcut) { return uniqueId !== shortcut.uniqueId; }), true), [
                {
                    uniqueId: uniqueId,
                    id: id,
                    char: char,
