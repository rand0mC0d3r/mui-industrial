...
var IndustrialProvider = function (_a) {
    ...
    var handleKeyboardsRegister = function (_a) {
        var _b = _a[0], id = _b.id, label = _b.label, ascii = _b.ascii, char = _b.char, shiftKey = _b.shiftKey, ctrlKey = _b.ctrlKey, altKey = _b.altKey, metaKey = _b.metaKey, onTrigger = _b.onTrigger, insensitive = _b.insensitive;
        var s = shortcuts.find(function (shortcut) { return shortcut.id === id; });
        if (s && generateSignature(s.id, s.label, s.ascii, s.char) === generateSignature(id, label, ascii, char))
            return;
        setShortcuts(function (prevShortcuts) {
