...
export default (function (_a) {
    ...
    return _jsx(_Fragment, { children: _jsx(StyledPopper, __assign({}, {
        ...
        }, { children: _jsx(ClickAwayListener, __assign({ onClickAway: function () { return handleClose(); } }, { children: _jsx(Tooltip, __assign({ open: true, placement: 'bottom', arrow: true, title: "Select another key combination for this action" }, { children: _jsx(StyledContainer, { children: _jsx(TextField, { size: "small", variant: 'outlined', label: "Key", autoFocus: true, onFocus: function (e) { return e.currentTarget.select(); }, InputProps: {
