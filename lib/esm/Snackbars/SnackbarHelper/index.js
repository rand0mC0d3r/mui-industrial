...
export default (function (_a) {
    ...
    return _jsx(_Fragment, { children: snackbarId
            && snackbarObject
            && _jsx(InternalAlert, { autoHideDuration: snackbarObject.autoHideDuration, actions: snackbarObject.actions, severity: snackbarObject.severity, code: snackbarObject.code, id: snackbarObject.id, message: snackbarObject.message }) });
});
