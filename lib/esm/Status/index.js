    ...
    return _jsx(_Fragment, { children: (statusObject !== null && !!id && elementFound)
            && createPortal((statusObject.visible && children) && _jsxs(SDiv, __assign({}, {
                ...
                isdisabled: disabled.toString(),
                        ...
                        ? _jsx(Tooltip, __assign({ title: _jsx("div", __assign({ style: { fontSize: '14px', maxHeight: '300px', overflow: 'scroll' } }, { children: tooltip })), arrow: true }, { children: _jsx(SSpan, { children: children }) }))
