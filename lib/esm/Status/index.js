...
export default function (_a) {
    var id = _a.id, _b = _a.disabled, disabled = _b === void 0 ? false : _b, _c = _a.highlight, highlight = _c === void 0 ? Highlight.DEFAULT : _c, _d = _a.options, options = _d === void 0 ? {
        as: StatusType.SIMPLE,
    } : _d, _e = _a.secondary, secondary = _e === void 0 ? false : _e, tooltip = _a.tooltip, onClick = _a.onClick, onContextMenu = _a.onContextMenu, style = _a.style, className = _a.className, children = _a.children;
