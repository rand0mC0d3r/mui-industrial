...
export default function (_a) {
    var _b, _c;
    var id = _a.id, style = _a.style, onClick = _a.onClick, onContextMenu = _a.onContextMenu, _d = _a.disabled, disabled = _d === void 0 ? false : _d, _e = _a.highlight, highlight = _e === void 0 ? Highlight.DEFAULT : _e, tooltip = _a.tooltip, children = _a.children, options = _a.options, _f = _a.secondary, secondary = _f === void 0 ? false : _f;
    var _g = useContext(DataProvider), status = _g.status, handleStatusUpdate = _g.handleStatusUpdate, handleStatusAnnouncement = _g.handleStatusAnnouncement, handleStatusDestroy = _g.handleStatusDestroy;
    var _h = useContext(DataProvider).settings, allowRightClick = _h.allowRightClick, position = _h.position;
    var _j = useState(), ownId = _j[0], setOwnId = _j[1];
    var _k = useState(null), statusObject = _k[0], setStatusObject = _k[1];
    var _l = useState(null), elementFound = _l[0], setElementFound = _l[1];
    ...
    return _jsx(_Fragment, { children: (statusObject !== null && !!id && elementFound)
            && createPortal((statusObject.visible && children) && _jsxs(SDiv, __assign({}, {
                ...
                startSeparator: (_b = combinedSeparators.start) === null || _b === void 0 ? void 0 : _b.toString(),
                endSeparator: (_c = combinedSeparators.end) === null || _c === void 0 ? void 0 : _c.toString(),
