...
import { domConsoleHeader, domConsoleId, Highlight, StatusType } from '../../../index.types';
...
export default (function (_a) {
    ...
    var _f = useState(null), elementHeaderFound = _f[0], setElementHeaderFound = _f[1];
    ...
    useEffect(function () {
        ...
        setElementHeaderFound(document.getElementById("".concat(domConsoleHeader, ".").concat(id)) || null);
    ...
    return _jsxs(_Fragment, { children: [_jsx(StatusCore, __assign({}, {
                ...
                && createPortal(options === null || options === void 0 ? void 0 : options.content, elementFound), elementHeaderFound
                && children
