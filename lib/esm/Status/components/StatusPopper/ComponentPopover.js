...
export default (function (_a) {
    ...
    return _jsx(_Fragment, { children: _jsx(StyledPopover, __assign({}, {
        ...
        }, { children: _jsxs(StyledContainer, __assign({}, {
                elevation: enrichedPopper.elevation,
            ...
            }, { children: [_jsx(StyledBox, __assign({ display: "flex", alignItems: "stretch", justifyContent: "space-between", flexDirection: "column", width: enrichedPopper.width, height: enrichedPopper.height }, { children: options === null || options === void 0 ? void 0 : options.content })), enrichedPopper.hasToolbar && _jsx(InternalHeader, __assign({}, {
                        sx: {
                            p: 1,
                        },
                        id: id,
