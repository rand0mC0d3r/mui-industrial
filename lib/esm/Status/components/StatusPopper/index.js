...
export default (function (_a) {
    ...
    return _jsxs(_Fragment, { children: [_jsx(StatusCore, __assign({}, {
                ...
                style: style,
                className: className,
            }, { children: children })), _jsx(Component, __assign({}, { id: id, enrichedPopper: enrichedPopper, highlight: highlight, statusObject: statusObject, anchorEl: anchorEl, setAnchorEl: setAnchorEl, options: options, secondary: secondary }))] });
});
