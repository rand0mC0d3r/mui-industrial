...
export default (function (_a) {
    ...
    var isIcon = icon !== undefined;
    var isBadge = badge !== undefined && String(badge).length > 0;
    var isText = text !== undefined && text.length > 0;
    var isChildren = children !== undefined;
    useEffect(function () {
    ...
    return _jsxs(StyledStack, __assign({}, { id: 'statusHelper', style: style, className: className, reverse: reverse.toString() }, { children: [isIcon && _jsx(StyledIcon, __assign({}, { id: 'sh.icon' }, { children: icon })), isBadge && _jsx(StyledBadge, __assign({}, { id: 'sh.badge' }, { children: String(badge) })), isText && _jsx(StyledText, __assign({}, { id: 'sh.text', variant: 'caption' }, { children: text })), isChildren && _jsx(_Fragment, { children: childrenOrder !== defaultChildrenOrder
                    ? _jsx(StyledChildren, __assign({}, { order: childrenOrder }, { children: children }))
                    : children }), !isIcon && !isBadge && !isText && !isChildren && _jsx(_Fragment, { children: _jsx(Tooltip, __assign({ arrow: true, placement: 'right', title: "This status element is showing a placeholder because no content was provided." }, { children: _jsx(QuestionMarkIcon, { color: "disabled", style: { fontSize: '16px' } }) })) })] }));
});
