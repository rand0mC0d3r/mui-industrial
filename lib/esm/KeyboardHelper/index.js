...
export default (function (_a) {
    var shortcutId = _a.shortcutId, _b = _a.asChip, asChip = _b === void 0 ? false : _b, _c = _a.hasTooltip, hasTooltip = _c === void 0 ? true : _c;
    ...
    var determineChip = _jsx(Chip, { label: shortcutString, variant: "outlined", size: "small" });
    var determineTypography = _jsx(Typography, __assign({ id: "lowerK", variant: "caption", color: "inherit" }, { children: shortcutString }));
    var determineTooltip = function (element) { return _jsx(_Fragment, { children: hasTooltip
