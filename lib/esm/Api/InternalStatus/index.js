...
export default (function (_a) {
    ...
    return _jsx(SWrapper, __assign({}, { justifyContent: justifyContent, width: width, fullWidth: fullWidth, hasBorder: hasBorder, position: position, style: style }, { children: status.length > 0 && _jsxs(_Fragment, { children: [_jsx(SPrimary, __assign({}, { id: "".concat(domStatusBarId, "-primary") })), _jsx(SSecondary, __assign({}, { id: "".concat(domStatusBarId, "-secondary") }))] }) }));
});
