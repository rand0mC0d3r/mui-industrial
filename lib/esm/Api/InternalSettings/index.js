...
export default (function (_a) {
    ...
    var statusEntry = function (statusItem) { return _jsx(SElementItem, __assign({ onClick: function () { return handleStatusVisibilityToggle({ id: statusItem.uniqueId }); } }, { children: statusItem.visible ? _jsx(CheckBoxOutlinedIcon, {}) : _jsx(CheckBoxOutlineBlankOutlinedIcon, {}) })); };
    var entryWrapper = function (statusItem) { return _jsx(Tooltip, __assign({}, { title: 'Toggle visibility of tile' }, { children: statusEntry(statusItem) }), statusItem.uniqueId); };
