...
export default (function () {
    ...
    return _jsx(_Fragment, { children: open && _jsx(_Fragment, { children: _jsx(Backdrop, __assign({ open: open, onClick: function () { return setOpen(false); } }, { children: _jsx("div", __assign({ style: {
                        position: 'absolute',
                        top: '32px',
                        display: 'flex',
                        justifyContent: 'center',
                        width: '100%',
                    } }, { children: _jsx(ClickAwayListener, __assign({ onClickAway: function () { return setOpen(false); } }, { children: _jsx(SPaper, __assign({ elevation: 8 }, { children: _jsx(Autocomplete, { disablePortal: true, open: true, autoHighlight: true, inputValue: inputValue, clearOnEscape: true, onClose: function (_, reason) {
                                    if (reason === 'escape')
                                        setOpen(false);
                                    ...
                                    return _jsx(Paper, __assign({ style: { position: 'relative' } }, { children: _jsx("div", __assign({ style: { position: 'relative' } }, { children: children })) }));
                                }, renderOption: function (props, option) {
                                    return _jsx("div", __assign({}, props, { onContextMenu: function (e) { return e.preventDefault(); } }, { children: _jsxs(Box, __assign({ display: "flex", justifyContent: 'space-between', style: { width: '100%' }, alignItems: "center" }, { children: [_jsxs(Box, __assign({ display: "flex", style: { gap: '8px' }, flexWrap: "nowrap", alignItems: "center" }, { children: [option.icon && cloneElement(option.icon, { style: { fontSize: '16px' } }), highlightString(option.label, inputValue)] })), option.shortcutId && _jsx(_Fragment, { children: _jsx(KeyboardHelper, { shortcutId: option.shortcutId, asChip: true }) })] })) }));
