...
export default (function (_a) {
    ...
    var _c = useContext(DataProvider), handleSnackbarHide = _c.handleSnackbarHide, snackbars = _c.snackbars;
    useEffect(function () {
        if (actions)
            setIsExpanded(true);
    }, [actions]);
