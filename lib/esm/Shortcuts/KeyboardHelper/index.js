...
export default (function (_a) {
    ...
    var determineChip = _jsx(Chip, { style: { userSelect: 'none' }, label: shortcutString(shortcutObject), variant: "outlined", size: "small" });
    var determineTypography = _jsx(Typography, __assign({ style: {
            userSelect: 'none',
            lineHeight: '1',
            display: 'flex',
            alignItems: 'center',
        }, variant: "caption", color: "inherit" }, { children: shortcutString(shortcutObject) }));
    var determineTooltip = function (element) {
        return (hasTooltip || hasOverride)
            ? _jsx(Tooltip, __assign({ title: _jsx("span", __assign({ style: { userSelect: 'none' } }, { children: tooltip })), placement: "right", arrow: true }, { children: _jsx("span", { children: element }) }))
            : element;
    };
