...
export default function (_a) {
    ...
    var _c = useContext(DataProvider).settings, position = _c.position, fullWidth = _c.fullWidth, hasBorder = _c.hasBorder, width = _c.width, justifyContent = _c.justifyContent;
