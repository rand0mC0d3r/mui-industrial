...
export default (function (_a) {
    ...
    return _jsxs(_Fragment, { children: [_jsxs(SBox, __assign({ id: "mui-status-wrapper" }, { column: position }, { children: [_jsx(SChildrenRow, { children: _jsxs(SChildren, __assign({ id: "mui-status-children" }, { children: [children, renderConsole, renderCommands] })) }), renderStatus, renderNotifications, renderKeyboards] })), _jsx(InternalSettings, __assign({}, { anchorEl: anchorEl, setAnchorEl: setAnchorEl }))] });
});
