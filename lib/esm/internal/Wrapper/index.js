...
var SStatusContainer = styled('div')(function (_a) {
    ...
    return ({
        ...
        boxShadow: fullWidth === 'true' && hasBorder === 'true'
            ? [
                "inset -3px 0px 0px 1px ".concat(theme.palette.divider),
            ].join(',')
            : 'none',
...
export default function (_a) {
    ...
    var _c = useContext(DataProvider).settings, position = _c.position, upperBar = _c.upperBar, fullWidth = _c.fullWidth, hasBorder = _c.hasBorder, width = _c.width, justifyContent = _c.justifyContent;
    ...
    return _jsxs(_Fragment, { children: [_jsxs(SBox, __assign({ id: "mui-status-wrapper" }, { column: position }, { children: [_jsxs(SChildren, __assign({ id: "mui-status-children" }, { children: [children, status.some(function (_a) {
                        ...
                        return visible;
                    }) && _jsx(SStatusContainer, __assign({}, {
                        fullWidth: fullWidth.toString(),
                        hasBorder: hasBorder.toString()
                    }, { children: _jsx(SStatusWrapper, __assign({}, {
