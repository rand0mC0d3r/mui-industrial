...
export default (function (_a) {
    ...
    var _b = useContext(DataProvider), status = _b.status, shortcuts = _b.shortcuts, commands = _b.commands, sidebars = _b.sidebars, settings = _b.settings;
    ...
    var renderNotifications = _jsx(SNotifications, __assign({}, { column: position }, { children: _jsx(InternalNotifications, {}) }));
    ...
    var renderSidebar = _jsx(_Fragment, { children: _jsx(InternalSidebar, {}) });
    return _jsxs(_Fragment, { children: [_jsxs(SBox, __assign({ id: "mui-status-wrapper" }, { column: position }, { children: [_jsxs(SChildrenRow, { children: [renderSidebar, _jsxs(SChildren, __assign({ id: "mui-status-children" }, { children: [children, renderConsole, renderCommands] }))] }), renderStatus, renderNotifications, renderKeyboards] })), _jsx(InternalSettings, __assign({}, { anchorEl: anchorEl, setAnchorEl: setAnchorEl }))] });
});
