...
export default (function (_a) {
    ...
    return _jsxs(SHeader, __assign({ expanded: isExpanded.toString() }, { children: [(isExpanded)
                ...
                : _jsx(_Fragment, { children: !actions
                        ...
                        : _jsx(STitle, __assign({ actions: actions, onDoubleClick: toggleExpanded, variant: "subtitle1", color: "inherit" }, { children: severity })) }), _jsxs(SActionButtons, { children: [!isExpanded && code && _jsx(Tooltip, __assign({ arrow: true, title: "It contains additional console details" }, { children: _jsx(SubtitlesOutlinedIcon, { color: "disabled" }) })), _jsx(SCustomAction, { id: composeDomId(componentId, [uniqueId, 'customAction']) }), !actions && _jsx(Tooltip, __assign({ arrow: true, title: "Expand/Collapse alert" }, { children: _jsx(IconButton, __assign({ color: "inherit", size: "small", onClick: toggleExpanded }, { children: !isExpanded
