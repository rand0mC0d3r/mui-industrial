...
export default function (_a) {
    ...
    return _jsxs(SFooter, { children: [source && _jsx(SSource, __assign({ variant: "caption", color: "textSecondary" }, { children: "Source: ".concat(source) })), _jsx(SActions, { children: actions && actions.map(function (action, i) { return _jsx(Fragment, { children: cloneElement(action, {
