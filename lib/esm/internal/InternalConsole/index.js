...
export default (function () {
    ...
    return _jsxs(_Fragment, { children: [_jsx(Keyboard, { id: "mui-industrial-open-console", label: "Open console", ascii: 27, char: "P", onTrigger: function () { return updateIsConsoleOpen(); } }), (isConsoleOpen) && _jsx(_Fragment, { children: status.some(function (_a) {
                    var type = _a.type;
                    return type === relevantType;
