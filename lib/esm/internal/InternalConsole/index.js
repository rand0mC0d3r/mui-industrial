    ...
    return _jsx(_Fragment, { children: (isConsoleOpen) && _jsx(_Fragment, { children: status.some(function (_a) {
                ...
                return type === relevantType;
                        ...
                        topLeft: false,
                            ...
                            ? _jsx(_Fragment, { children: _jsxs(StyledContainer, __assign({ position: position.toString() }, { children: [_jsxs("div", __assign({ style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginRight: '4px' } }, { children: [_jsx(StyledTabs, { children: relevantConsoles.map(function (_a) {
                            ...
                            : _jsxs(StyledEmptyWrapper, { children: [_jsx(AppsOutageIcon, {}), status.filter(function (_a) {
                                        var type = _a.type;
                                        return type === relevantType;
                                    }).map(function (statusItem) { return _jsx(Fragment, { children: statusItem.children }, statusItem.uniqueId); }), _jsx(Typography, __assign({}, { variant: 'caption', color: 'textSecondary' }, { children: "Seems no consoles available. Select one from above" }))] }) }) })) })) }) });
});
