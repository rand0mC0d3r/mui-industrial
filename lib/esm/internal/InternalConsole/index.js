                ...
                return type === relevantType;
                        ...
                        if (computedHeight < 125) {
                            ...
                            ? _jsxs("div", __assign({ style: {
                                ...
                                } }, { children: [_jsxs("div", __assign({ style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' } }, { children: [_jsx(StyledTabs, { children: relevantConsoles.map(function (_a) {
