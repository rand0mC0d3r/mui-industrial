                ...
                return type === relevantType;
                        ...
                        topLeft: false,
                            ...
                            : _jsx(StyledEmptyWrapper, { children: _jsx(Box, __assign({ display: 'flex', flexDirection: "row", style: { gap: '8px' } }, { children: status.filter(function (_a) {
                                        var type = _a.type;
                                        return type === relevantType;
                                    }).map(function (statusItem) { return _jsx(Paper, __assign({ style: { padding: '32px' }, elevation: 3, onClick: function () { return updateConsoleActiveId({ id: statusItem.uniqueId }); } }, { children: statusItem.children }), statusItem.uniqueId); }) })) }) }) })) })) }) });
});
