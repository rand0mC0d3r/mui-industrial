...
export default (function (_a) {
    ...
    return _jsxs(StyledActionsWrapper, __assign({ onContextMenu: function (e) { e.preventDefault(); } }, { children: [_jsx(StyledTypography, __assign({ variant: "subtitle2", color: "textSecondary" }, { children: title })), _jsxs(StyledActions, { children: [_jsx(InternalActions, __assign({}, { actions: actions })), !noDefaults && settings.hasLock && _jsx(InternalActions, __assign({}, {
                        actions: [
                            {
                                tooltip: 'Toggle keep-open',
                                icon: (statusObject === null || statusObject === void 0 ? void 0 : statusObject.keepOpen) ? _jsx(LockOutlinedIcon, { color: "primary" }) : _jsx(LockOpenOutlinedIcon, { style: { fontSize: '40px' } }),
