...
export default (function (_a) {
    ...
    return _jsxs(StyledActionsWrapper, __assign({ onContextMenu: function (e) { e.preventDefault(); } }, { children: [_jsx(StyledTypography, __assign({ variant: "subtitle2", color: "textSecondary" }, { children: title })), _jsxs(StyledActions, { children: [actions && actions
                        .filter(function (_, i) { return i < 3; })
                        .map(function (action) { return _jsx(Tooltip, __assign({ arrow: true }, { title: action === null || action === void 0 ? void 0 : action.title }, { children: _jsx("span", { children: _jsx(IconButton, __assign({ size: "small" }, { onClick: function () { return action === null || action === void 0 ? void 0 : action.onClick(); }, disabled: action === null || action === void 0 ? void 0 : action.disabled }, { children: action === null || action === void 0 ? void 0 : action.icon })) }) }), action === null || action === void 0 ? void 0 : action.title); }), !noDefaults && settings.hasLock && _jsx(Tooltip, __assign({ title: "Toggle keep-open", arrow: true }, { children: _jsx(IconButton, __assign({ size: "small", onClick: function () { return handleStatusKeepOpenToggle({ id: id }); } }, { children: (statusObject === null || statusObject === void 0 ? void 0 : statusObject.keepOpen) ? _jsx(LockOutlinedIcon, { color: "primary" }) : _jsx(LockOpenOutlinedIcon, {}) })) }))] })] }));
});
