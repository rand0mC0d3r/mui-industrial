...
export default (function () {
    ...
    var highlightString = function (str, search) {
        ...
        return _jsx("span", { children: parts.map(function (part, i) { return _jsx("span", __assign({ style: part.toLowerCase() === search.toLowerCase() ? { fontWeight: 700 } : {} }, { children: part }), i); }) });
    };
    useEffect(function () {
    ...
    return _jsx(_Fragment, { children: open && _jsx("div", __assign({ style: {
                ...
                width: '100%',
            } }, { children: _jsx(ClickAwayListener, __assign({ onClickAway: function () { return setOpen(false); } }, { children: _jsx(Paper, __assign({ style: { width: '60vw', maxWidth: '750px', padding: '8px' }, elevation: 8 }, { children: _jsx(Autocomplete, { disablePortal: true, open: true, clearOnEscape: true, autoSelect: true, onInputChange: function (_, newInputValue) {
                            ...
                            return _jsx("div", __assign({}, props, { onContextMenu: function (e) { return e.preventDefault(); } }, { children: _jsxs(Box, __assign({ display: "flex", justifyContent: 'space-between', style: { width: '100%' }, alignItems: "center" }, { children: [_jsxs(Box, __assign({ display: "flex", style: { gap: '8px' }, flexWrap: "nowrap", alignItems: "center" }, { children: [cloneElement(option.icon, { style: { fontSize: '16px' } }), _jsx(Typography, __assign({ variant: "subtitle2", color: "textSecondary" }, { children: highlightString(option.label, inputValue) }))] })), option.shortcutId && _jsx(_Fragment, { children: _jsx(KeyboardHelper, { shortcutId: option.shortcutId, asChip: true }) })] })) }));
