...
export default (function () {
    var _a = useContext(DataProvider), handleKeyboardRegister = _a.handleKeyboardRegister, commands = _a.commands;
    ...
    return _jsx(_Fragment, { children: open && _jsx("div", __assign({ style: {
                ...
                width: '100%',
            } }, { children: _jsx(ClickAwayListener, __assign({ onClickAway: function () { return setOpen(false); } }, { children: _jsx(Paper, __assign({ style: { width: '60vw', maxWidth: '750px', padding: '8px' }, elevation: 8 }, { children: _jsx(Autocomplete, { disablePortal: true, open: true, clearOnEscape: true, autoSelect: true, onChange: function (e, v) {
                            console.log(v);
                            setOpen(false);
