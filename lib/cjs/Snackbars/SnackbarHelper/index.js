...
exports.default = (function (_a) {
    ...
    return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: snackbarId
            && snackbarObject
            && (0, jsx_runtime_1.jsx)(InternalAlert_1.default, { autoHideDuration: snackbarObject.autoHideDuration, actions: snackbarObject.actions, severity: snackbarObject.severity, code: snackbarObject.code, id: snackbarObject.id, message: snackbarObject.message }) });
});
