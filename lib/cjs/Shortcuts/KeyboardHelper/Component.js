...
exports.default = (function (_a) {
    ...
    return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(css_1.StyledPopper, __assign({}, {
        ...
        }, { children: (0, jsx_runtime_1.jsx)(material_1.ClickAwayListener, __assign({ onClickAway: function () { return handleClose(); } }, { children: (0, jsx_runtime_1.jsxs)(material_1.Box, __assign({ display: 'flex', flexDirection: 'column', gap: 2, sx: {
                        p: 2,
                        width: '285px',
                        borderRadius: 2,
                        border: 1,
