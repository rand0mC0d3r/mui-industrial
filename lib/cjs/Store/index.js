...
exports.IndustrialProvider = exports.composeDomId = void 0;
...
var IndustrialProvider = function (_a) {
    ...
    var _k = (0, react_1.useState)([]), commands = _k[0], setCommands = _k[1];
    var _l = (0, react_1.useState)([]), shortcuts = _l[0], setShortcuts = _l[1];
    var _m = (0, react_1.useState)(initialSettings), settings = _m[0], setSettings = _m[1];
    ...
    (0, react_1.useEffect)(function () { return dumpContext('📟 Snackbar', snackbar); }, [snackbar, dumpContext]);
