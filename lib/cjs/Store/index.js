...
exports.IndustrialProvider = exports.packageName = exports.composeDomId = void 0;
var jsx_runtime_1 = require("react/jsx-runtime");
var react_1 = require("react");
var Wrapper_1 = __importDefault(require("../Api/Wrapper"));
...
var IndustrialProvider = function (_a) {
    var slim = _a.slim, expand = _a.expand, hasLock = _a.hasLock, _b = _a.position, position = _b === void 0 ? index_types_1.PlacementPosition.TOP : _b, allowRightClick = _a.allowRightClick, _c = _a.hasBorder, hasBorder = _c === void 0 ? true : _c, _d = _a.fullWidth, fullWidth = _d === void 0 ? false : _d, _e = _a.justifyContent, justifyContent = _e === void 0 ? 'space-between' : _e, debug = _a.debug, children = _a.children, style = _a.style, _f = _a.size, size = _f === void 0 ? 'small' : _f, _g = _a.variant, variant = _g === void 0 ? 'default' : _g;
    var _h = (0, react_1.useState)([]), sidebars = _h[0], setSidebars = _h[1];
    var _j = (0, react_1.useState)([]), status = _j[0], setStatus = _j[1];
    var _k = (0, react_1.useState)([]), snackbars = _k[0], setSnackbars = _k[1];
    var _l = (0, react_1.useState)([]), commands = _l[0], setCommands = _l[1];
    var _m = (0, react_1.useState)([]), shortcuts = _m[0], setShortcuts = _m[1];
    var _o = (0, react_1.useState)(initialSettings), settings = _o[0], setSettings = _o[1];
    ...
    var log = (0, react_1.useCallback)(function () {
        ...
        if (settings.debug) {
            logger_1.logPackage.apply(void 0, props);
        }
    }, [settings.debug]);
    var logn = (0, react_1.useCallback)(function () {
        var props = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            props[_i] = arguments[_i];
        }
        if (settings.debug) {
            logger_1.lognPackage.apply(void 0, props);
        }
    }, [settings.debug]);
    ...
    var dumpContext = (0, react_1.useCallback)(function (label, content) {
        if (settings.debug) {
            logn(label, content.length);
            log(content.length > 0 ? __spreadArray([], content, true) : 'No entries found.');
        }
    }, [settings.debug, log, logn]);
    (0, react_1.useEffect)(function () { return dumpContext('🗄️ Status', status); }, [status, dumpContext]);
    (0, react_1.useEffect)(function () { return dumpContext('📟 Snackbar', snackbars); }, [snackbars, dumpContext]);
    (0, react_1.useEffect)(function () { return dumpContext('🫙 Shortcuts', shortcuts); }, [shortcuts, dumpContext]);
    (0, react_1.useEffect)(function () { return dumpContext('🎯 Commands', commands); }, [commands, dumpContext]);
    (0, react_1.useEffect)(function () { return dumpContext('🎛️ Sidebar', sidebars); }, [sidebars, dumpContext]);
    return (0, jsx_runtime_1.jsx)(DataContext.Provider, __assign({ value: {
            ...
            logDebug: logDebug,
        } }, { children: (0, jsx_runtime_1.jsx)(Wrapper_1.default, __assign({}, { children: children, slim: slim, style: style })) }));
};
exports.IndustrialProvider = IndustrialProvider;
