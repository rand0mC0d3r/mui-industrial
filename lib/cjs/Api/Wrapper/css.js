...
exports.SBox = (0, styles_1.styled)('div')(function (_a) {
    var column = _a.column, slim = _a.slim;
    return ({
        ...
        position: 'absolute',
        display: 'flex',
        top: slim ? column === index_types_1.PlacementPosition.TOP ? '0px' : 'unset' : '0px',
        bottom: slim ? column === index_types_1.PlacementPosition.BOTTOM ? '0px' : 'unset' : '0px',
        left: '0px',
        right: '0px',
        zIndex: slim ? '2345' : '0',
