...
exports.default = (function (_a) {
    ...
    var _b = (0, react_1.useContext)(Store_1.default), status = _b.status, shortcuts = _b.shortcuts, commands = _b.commands, settings = _b.settings, snackbars = _b.snackbars;
    ...
    var renderNotifications = snackbars.length > 0 && (0, jsx_runtime_1.jsx)(css_1.SNotifications, __assign({}, { column: position }, { children: (0, jsx_runtime_1.jsx)(InternalNotifications_1.default, {}) }));
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(css_1.SBox, __assign({ id: "mui-status-wrapper" }, { column: position, slim: slim }, { children: [(0, jsx_runtime_1.jsx)(css_1.SChildrenRow, { children: (0, jsx_runtime_1.jsx)(css_1.SChildren, __assign({ id: "mui-status-children" }, { children: children })) }), renderConsole, renderCommands, renderStatus, renderNotifications, renderKeyboards] })), (0, jsx_runtime_1.jsx)(InternalSettings_1.default, __assign({}, { anchorEl: anchorEl, setAnchorEl: setAnchorEl }))] });
});
