...
exports.default = (function () {
    var _a = (0, react_1.useContext)(Store_1.default), status = _a.status, updateConsoleActiveId = _a.updateConsoleActiveId, updateIsConsoleOpen = _a.updateIsConsoleOpen, handleKeyboardsRegister = _a.handleKeyboardsRegister;
    ...
    return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (isConsoleOpen) && (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: status.some(function (_a) {
                ...
                return type === relevantType;
                        ...
                        bottomLeft: false,
                        topLeft: false,
                    }, onResizeStop: function (_e, _direction, _ref, d) { return computeHeight(d.height); }, style: { display: 'flex', flexDirection: 'column' }, minHeight: "75px", maxHeight: "950px", defaultSize: { width: width, height: height || '350px' } }, { children: (0, jsx_runtime_1.jsx)(css_1.StyledResizable, __assign({ id: 'resizable' }, { children: relevantConsoles.some(function (_a) {
                            var uniqueId = _a.uniqueId;
                            return uniqueId === consoleActiveId;
                        })
                            ? (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)(css_1.StyledContainer, __assign({ id: "consoleTabs", position: position.toString() }, { children: [(0, jsx_runtime_1.jsxs)(css_1.StyledTabsAndActionWrapper, { children: [(0, jsx_runtime_1.jsx)(css_1.StyledTabs, { children: relevantConsoles.map(function (_a) {
                                                        ...
                                                        }, { children: (0, jsx_runtime_1.jsx)(material_1.Box, __assign({ id: "".concat(index_types_1.domConsoleHeader, ".").concat(uniqueId), alignItems: "center", display: 'flex', flexDirection: 'row-reverse', flexWrap: 'nowrap', style: { gap: '8px', pointerEvents: 'none' } }, { children: (0, jsx_runtime_1.jsx)(InternalActions_1.default, { actions: options.actions, fontSize: "14px" }) })) }));
                            ...
                            : (0, jsx_runtime_1.jsx)(css_1.StyledEmptyWrapper, { children: (0, jsx_runtime_1.jsx)(material_1.Box, __assign({ display: 'flex', flexDirection: "row", style: { gap: '8px' } }, { children: status.filter(function (_a) {
                                        var type = _a.type;
                                        return type === relevantType;
                                    }).map(function (statusItem) { return (0, jsx_runtime_1.jsx)(material_1.Button, __assign({ style: { padding: '24px', textTransform: 'unset' }, variant: "outlined", color: "inherit", onClick: function () { return updateConsoleActiveId({ id: statusItem.uniqueId }); } }, { children: (0, jsx_runtime_1.jsx)(material_1.Box, __assign({ display: 'flex', flexDirection: "column", style: { gap: '8px' } }, { children: (0, jsx_runtime_1.jsx)(material_1.Typography, __assign({ variant: "caption", color: "textSecondary" }, { children: statusItem.options.title })) })) }), statusItem.uniqueId); }) })) }) })) })) })) }) });
});
