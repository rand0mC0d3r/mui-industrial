...
exports.default = (function (_a) {
    ...
    return (0, jsx_runtime_1.jsxs)(css_1.StyledBox, __assign({}, { sx: sx }, { display: "flex", alignItems: "center", justifyContent: "space-between", onContextMenu: function (e) { e.preventDefault(); } }, { children: [(0, jsx_runtime_1.jsx)(css_1.StyledTypography, __assign({ variant: "subtitle2", color: "textSecondary" }, { children: title })), (0, jsx_runtime_1.jsxs)(css_1.StyledActions, { children: [(0, jsx_runtime_1.jsx)(InternalActions_1.default, __assign({}, { actions: actions })), !noDefaults && settings.hasLock && (0, jsx_runtime_1.jsx)(InternalActions_1.default, __assign({}, {
                        actions: [
                            {
                                preserveColor: true,
                                tooltip: 'Toggle keep-open',
                                icon: (statusObject === null || statusObject === void 0 ? void 0 : statusObject.keepOpen) ? (0, jsx_runtime_1.jsx)(LockOutlined_1.default, { color: "primary" }) : (0, jsx_runtime_1.jsx)(LockOpenOutlined_1.default, {}),
