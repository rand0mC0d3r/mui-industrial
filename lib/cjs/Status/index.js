    ...
    return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (statusObject !== null && !!id && elementFound)
            && (0, react_dom_1.createPortal)((statusObject.visible && children) && (0, jsx_runtime_1.jsxs)(SDiv, __assign({}, {
                ...
                isdisabled: disabled.toString(),
                        ...
                        ? (0, jsx_runtime_1.jsx)(material_1.Tooltip, __assign({ title: (0, jsx_runtime_1.jsx)("div", __assign({ style: { fontSize: '14px', maxHeight: '300px', overflow: 'scroll' } }, { children: tooltip })), arrow: true }, { children: (0, jsx_runtime_1.jsx)(SSpan, { children: children }) }))
