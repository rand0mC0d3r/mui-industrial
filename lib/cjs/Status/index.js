...
var StatusConsole_1 = __importDefault(require("./components/StatusConsole"));
var StatusCore_1 = __importDefault(require("./components/StatusCore"));
var StatusPopper_1 = __importDefault(require("./components/StatusPopper"));
...
var Status = function (_a) {
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [combinedOptions.as === index_types_1.StatusType.SIMPLE && (0, jsx_runtime_1.jsx)(StatusCore_1.default, __assign({}, props)), combinedOptions.as === index_types_1.StatusType.POPPER && (0, jsx_runtime_1.jsx)(StatusPopper_1.default, __assign({}, props)), combinedOptions.as === index_types_1.StatusType.CONSOLE && (0, jsx_runtime_1.jsx)(StatusConsole_1.default, __assign({}, props))] });
};
/**
