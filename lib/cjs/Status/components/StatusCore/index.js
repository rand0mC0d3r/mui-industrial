...
exports.StatusCore = (0, react_1.forwardRef)(function (props, ref) {
    ...
    var callbackHandleStatusAnnouncement = (0, react_1.useCallback)(function () {
        handleStatusAnnouncement({ id: id, ownId: ownId, options: options });
    ...
    return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (statusObject !== null && !!id && elementFound)
            && (0, react_dom_1.createPortal)((statusObject.visible && children) && (0, jsx_runtime_1.jsx)(css_1.SDiv, __assign({}, {
                id: id,
                ref: ref,
                ...
                isdisabled: disabled.toString(),
                    ...
                    : (0, jsx_runtime_1.jsx)(css_1.SSpan, { children: children }) }), "mui-status-".concat(id)), elementFound) });
});
