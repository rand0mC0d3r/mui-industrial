...
exports.default = (function (_a) {
    ...
    var _f = (0, react_1.useState)(null), elementHeaderFound = _f[0], setElementHeaderFound = _f[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        setElementHeaderFound(document.getElementById("".concat(index_types_1.domConsoleHeader, ".").concat(id)) || null);
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(StatusCore_1.default, __assign({}, {
                ...
                && (0, react_dom_1.createPortal)(options === null || options === void 0 ? void 0 : options.content, elementFound), elementHeaderFound
                && children
                && (0, react_dom_1.createPortal)(children, elementHeaderFound)] });
});
