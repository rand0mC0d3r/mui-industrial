...
var InternalHeader_1 = __importDefault(require("../../../Api/InternalHeader"));
...
exports.default = (function (_a) {
    ...
    return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(css_1.StyledPopper, __assign({}, {
            ...
            id: "mui-status-panel-popover-".concat(id),
                ...
                }, { children: [(0, jsx_runtime_1.jsx)(css_1.StyledBox, __assign({ ref: boxRef, tabIndex: 0, onKeyDown: function (event) {
                                if (event.key === 'Escape')
                                    handleOnClose(event);
                            }, display: "flex", alignItems: "stretch", justifyContent: "space-between", flexDirection: "column", width: enrichedPopper.width, height: enrichedPopper.height }, { children: options === null || options === void 0 ? void 0 : options.content })), enrichedPopper.hasToolbar && (0, jsx_runtime_1.jsx)(InternalHeader_1.default, __assign({}, {
                            sx: {
                                p: 1,
                            },
                            id: id,
