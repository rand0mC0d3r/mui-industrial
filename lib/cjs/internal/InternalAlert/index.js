...
exports.default = (function (_a) {
    var id = _a.id, actions = _a.actions, source = _a.source, severity = _a.severity, message = _a.message, code = _a.code, _b = _a.isRemoveFlag, isRemoveFlag = _b === void 0 ? false : _b;
