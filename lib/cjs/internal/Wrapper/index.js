...
var SStatusContainer = (0, styles_1.styled)('div')(function (_a) {
    ...
    return ({
        ...
        boxShadow: fullWidth === 'true' && hasBorder === 'true'
            ? [
                "inset 0px 0px 0px 1px ".concat(theme.palette.divider),
            ].join(',')
            : 'none',
...
function default_1(_a) {
    ...
    var _c = (0, react_1.useContext)(Store_1.default).settings, position = _c.position, upperBar = _c.upperBar, fullWidth = _c.fullWidth, hasBorder = _c.hasBorder, width = _c.width, justifyContent = _c.justifyContent;
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(SBox, __assign({ id: "mui-status-wrapper" }, { column: position }, { children: [(0, jsx_runtime_1.jsxs)(SChildren, __assign({ id: "mui-status-children" }, { children: [children, status.some(function (_a) {
                        ...
                        return visible;
                    }) && (0, jsx_runtime_1.jsx)(SStatusContainer, __assign({}, {
                        fullWidth: fullWidth.toString(),
                        hasBorder: hasBorder.toString()
                    }, { children: (0, jsx_runtime_1.jsx)(SStatusWrapper, __assign({}, {
