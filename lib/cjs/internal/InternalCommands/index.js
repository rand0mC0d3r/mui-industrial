...
var InternalHeader_1 = __importDefault(require("../InternalHeader"));
...
exports.default = (function () {
    ...
    return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: open && (0, jsx_runtime_1.jsx)("div", __assign({ style: {
                position: 'absolute',
                top: '32px',
                display: 'flex',
                justifyContent: 'center',
                width: '100%',
            } }, { children: (0, jsx_runtime_1.jsx)(material_1.ClickAwayListener, __assign({ onClickAway: function () { return setOpen(false); } }, { children: (0, jsx_runtime_1.jsx)(material_1.Paper, __assign({ style: { width: '60vw', maxWidth: '750px', padding: '12px', borderRadius: '8px' }, elevation: 8 }, { children: (0, jsx_runtime_1.jsx)(material_1.Autocomplete, { disablePortal: true, open: true, autoHighlight: true, inputValue: inputValue, clearOnEscape: true, onClose: function (_, reason) {
                            if (reason === 'escape')
                                setOpen(false);
                            ...
                            return (0, jsx_runtime_1.jsxs)(material_1.Paper, __assign({ style: { position: 'relative' } }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ style: { position: 'relative' } }, { children: children })), (0, jsx_runtime_1.jsx)(InternalHeader_1.default, { id: "quickCommands", noDefaults: true, title: 'Quick commands' })] }));
                        }, renderOption: function (props, option) {
                            return (0, jsx_runtime_1.jsx)("div", __assign({}, props, { onContextMenu: function (e) { return e.preventDefault(); } }, { children: (0, jsx_runtime_1.jsxs)(material_1.Box, __assign({ display: "flex", justifyContent: 'space-between', style: { width: '100%' }, alignItems: "center" }, { children: [(0, jsx_runtime_1.jsxs)(material_1.Box, __assign({ display: "flex", style: { gap: '8px' }, flexWrap: "nowrap", alignItems: "center" }, { children: [(0, react_1.cloneElement)(option.icon, { style: { fontSize: '16px' } }), highlightString(option.label, inputValue)] })), option.shortcutId && (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(KeyboardHelper_1.default, { shortcutId: option.shortcutId, asChip: true }) })] })) }));
                        }, id: "combo-box-demo", options: commands, renderInput: function (params) { return (0, jsx_runtime_1.jsx)(material_1.TextField, __assign({ autoFocus: true }, params, { fullWidth: true, size: "small", label: "Commands" })); } }) })) })) })) });
});
