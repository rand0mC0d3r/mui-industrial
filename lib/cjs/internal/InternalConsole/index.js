                ...
                return type === relevantType;
                        ...
                        if (computedHeight < 125) {
                            ...
                            ? (0, jsx_runtime_1.jsxs)("div", __assign({ style: {
                                ...
                                } }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' } }, { children: [(0, jsx_runtime_1.jsx)(StyledTabs, { children: relevantConsoles.map(function (_a) {
